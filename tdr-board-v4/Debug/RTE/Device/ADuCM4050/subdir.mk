...
RTE/Device/ADuCM4050/adi_adc.o: C:/Analog\ Devices/CrossCore\ Embedded\ Studio\ 2.10.1/ARM/packs/AnalogDevices/ADuCM4x50_DFP/4.0.0/Source/drivers/adc/adi_adc.c
	...
	arm-none-eabi-gcc -g -gdwarf-2 -ffunction-sections -fdata-sections -DCORE0 -D_DEBUG -D_RTE_ -D__ADUCM4050__ -D__SILICON_REVISION__=0x1 @includes-17e2d67edf4b8838b45787b6d6979605.txt -Wall -c -mcpu=cortex-m4 -mthumb -mfpu=fpv4-sp-d16 -mfloat-abi=hard -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@)" -o  "$@" "$<"
...
RTE/Device/ADuCM4050/%.o: ../RTE/Device/ADuCM4050/%.S
	...
	arm-none-eabi-gcc -c -x assembler-with-cpp -g -gdwarf-2 -DCORE0 -D_DEBUG -D_RTE_ -D__ADUCM4050__ -D__SILICON_REVISION__=0x1 @includes-17e2d67edf4b8838b45787b6d6979605.txt -mcpu=cortex-m4 -mthumb -mfpu=fpv4-sp-d16 -mfloat-abi=hard -o  "$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '
